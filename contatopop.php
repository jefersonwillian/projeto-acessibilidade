...
<body class="body-pop">
	<div class="text-center model-pop">
		<div class="col-md-12 icon-pop">
			<i class="fa fa-check-circle"></i>
		</div>	
		<div class="col-md-12 title-pop" tabindex="0">
			Mensagem enviada com sucesso!
		</div>	
		<div class="col-md-12 text-pop" tabindex="0"> 
			Iremos entrar em contato o mais rápido possível. Muito Obrigado!
		</div>
		<div class="col-md-12">
			<button class="button-pop" onclick="window.open('index.php', '_self');">Ok</button>
		</div>
	</div>
</body>
</html>